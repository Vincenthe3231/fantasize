    ...
    <div className="w-[300px] relative">
      ...
      <NodeContentFocus nodeId={id}>
        ...
        <textarea
          ...
          className="w-full rounded-lg p-2 text-[12px] text-[var(--text-primary)] resize-none outline-none min-h-[50px] border border-[var(--node-control-border)] bg-[var(--node-control-bg)] placeholder:text-[var(--text-muted)]"
        ...
        {status === 'generating' && (
          <div className="h-[120px] rounded-lg bg-[var(--node-control-bg)] border border-[var(--node-panel-border)] flex flex-col items-center justify-center gap-2">
