...
const BUSINESS_COPY =
  'You can adjust or add new camera angles using Reframe mode. Open the Perspectives control in this node to refine the shot for this stage of your project.';
          ...
          >
            <div className="rounded-[10px] overflow-hidden bg-[var(--node-inner-deep)] flex flex-col flex-1 min-h-0">
              <div className="flex flex-1 flex-col items-center justify-center gap-2 px-6 py-10 text-center min-h-[140px]">
                ...
                <p className="text-[11px] text-[var(--text-muted)] leading-relaxed max-w-[300px] mt-1">
                  {BUSINESS_COPY}
                </p>
              </div>
              ...
              >
                <div className="flex flex-col gap-1.5 w-fit">
                  ...
                  <button
                    type="button"
                    className="p-1.5 rounded-lg text-[var(--node-control-muted)] hover:bg-[var(--node-action-bar-hover-bg)] hover:text-[var(--node-control-text)] shrink-0"
                    title="Refresh"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <RefreshCw size={14} />
